...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ,Contenido("Hacer barquitos de papel y jugar en fuente de agua","3","Interacción y Comprensión \n" + " del Entorno","Pensamiento Matemático ","Medio", "Experimentar con materiales cotidianos tales como: agua y aire describiendo lo observado.","https://www.youtube.com/watch?v=Laj6AuGri2w","En esta actividad los niños podrán elavorar un barco de papel y luego descubrir los principios de flotabilidad","¿Qué materiales usar? \n" +
            ...
            ,Contenido("Historia Compartida","3","Comunicación Integral","Lenguaje Verbal ","Medio", "Manifestar interés por descubrir el contenido de textos, a través de la, la escucha atenta, la expresión de ideas y la formulación de preguntas.","https://www.youtube.com/watch?v=2x_Kr_EH7b0","En esta actividad los niños podrán practicar su lenguaje verbal.","¿Qué materiales usar? \n" +
            ...
            ,Contenido("Jugando a las sonrisas","3","Desarrollo Personal y Social","Identidad y autonomía ","Sala Cuna", "Expresar vocal, gestual o corporalmente distintas necesidades o emociones (alegría, miedo, pena, entre otras)","https://www.youtube.com/watch?v=2vDqG65_cGg","En esta actividad los niños podrán interactuar con títeres hechos en casa.","¿Qué materiales usar? \n" +
            ...
            ,Contenido("Mensajes de apoyo","3","Desarrollo Personal y Social","Convivencia y ciudadanía","Medio", "Participar en actividades grupales, conversando, cooperando, entre otras","https://www.youtube.com/watch?v=prHuClGHtmY","En esta actividad los niños podrán entender y analizar el contexto de la pandemia actual.","¿Qué materiales usar? \n" +
            ...
            ,Contenido("Circuito con tubos","3","Desarrollo Personal y Social","Corporalidad y Movimiento","Medio", "Perfeccionar su coordinación visomotora fina, a través del uso de diversos objetos.","https://www.youtube.com/watch?v=9URGRMp4Z-g","En esta actividad los niños podrán visualizar y diferenciar los seres vivos del reino animal.","¿Qué materiales usar? \n" +
            ...
            ,Contenido("Disfrutemos los sonidos","3","Comunicación Integral","Lenguajes artísticos","Sala cuna", "Manifestar interés por los sonidos, colores, luminosidad de su entorno, respondiendo a través de diversas formas, tales como balbuceos, gestos, sonrisas, entre otros","https://www.youtube.com/watch?v=jBN8ZQfb7iM","En esta actividad los niños podrán con sonidos de forma controlada.","¿Qué materiales usar? \n" +
